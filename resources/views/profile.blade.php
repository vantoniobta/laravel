         ...
         <form enctype="multipart/form-data" action="profile/{{$user->id}}" method="POST">
               <div class="col-md-8" >
                  <div class="panel panel-default">
                      <div class="panel-heading" style="background-color:#5DBFE3; color: #fff"><b><h5 id="title_vacantes"><i class="fas fa-chart-line"></i>&nbsp;Informacion Personal</h5></b></div>
               ...
               <div class="col-md-4" >
                    <div class="panel panel-default">
                        <div class="panel-heading" style="background-color:#5DBFE3; color: #fff"><b><h5 id="title_vacantes"><i class="fas fa-chart-line"></i>&nbsp;Imagen Profile</h5></b></div>
                        <div class="panel-body">
                            <img src="uploads/avatars/{{$user->avatar}}" class="img-circle center-block" width="20%">
                            <h3 style=" font-family: 'Armata', sans-serif; color: #000" align="center">{{ $user->name }}</h3>
                            ...
                            <div class="col-md-4">
                                  @if ($user->cv =='vacio.pdf')
                                   <p style="color: red; font-family: 'Armata', sans-serif;"><b>Aun no haz adjuntado tu CV</b><img src="https://media.giphy.com/media/QbHv7GZj688bS/giphy.gif" width="10%"></p>
                                    @else
                                      <h6 style="font-family: 'Armata', sans-serif;" align="center"><a href="uploads/cv/{{$user->id}}/{{$user->cv}}" style="color:#000" target="_blank">&nbsp;{{$user->cv}}</a></h6>
                                  @endif
