...
<div class="container">
   <div class="row">
           ...
           <div class="col-md-4" >
            <div class="panel panel-default" id="div_home">
                <div class="panel-heading" style="background-color:#5DBFE3; color: #fff"><b><h5 id="title_vacantes"><i class="fas fa-chart-line"></i>&nbsp;Adjuntar Curriculum(.pdf, .docx)</h5></b></div>
                <div class="panel-body">
...
<div class="container">
   <div class="row" >
     <div class="col-md-4" id="profile_data1"><br>
      <img src="uploads/avatars/{{$user->avatar}}" class="img-circle center-block" alt="Cinque Terre" width="10%">
